      ...
      <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-auto">
          ...
          <form id="gift-form" class="space-y-4">
            <div>
              <label for="gift-title" class="block text-sm font-medium text-gray-700">Title*</label>
            ...
            <div>
              <label for="gift-hyperlink" class="block text-sm font-medium text-gray-700">Link URL*</label>
            ...
            <div>
              <label for="gift-note" class="block text-sm font-medium text-gray-700">Note (optional)</label>
